        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Movimientos Financieros</h3>
                    <div id="content-1">
                                ...
                                <form method = "post">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="mb-3"><label class="form-label" for="username"><strong>Fecha</strong></label><input class="form-control" type="date" name="fecha" required=""></div>
                                        </div>
                                        <div class="col">
                                    ...
                                    <div class="mb-3"><button class="btn btn-primary btn-sm" type="submit" name = "Finanza">Añadir</button></div>
                                </form>
                                <?php 
                                        include("finanzas.php");
                                    ?>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <?php
                                        ...
                                        $sql = "SELECT * FROM operacionesfinancieras";
